...
import time
data_name = "NeurlPS_CITE_90k"
test_GEX = "C:/D/code/pycharmCode/04Mycode/multiModel/Dataset/ADT_others/"+ data_name +"/"
test_ATAC = "C:/D/code/pycharmCode/04Mycode/multiModel/Dataset/ADT_others/"+ data_name +"/"

test_paths = [test_GEX, test_ATAC]
test_names = [data_name + "_rna.h5ad",data_name + "_adt.h5ad",]

X1, Y1,adata_mod1,adata_mod2, h = getXY_protein(test_paths, test_names)
start = time.time()
a, b, c = X1.shape
